...
public class MyAccountServlet extends HttpServlet {
	...
	// 咨询师的账户列表
	private void userFundList(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	// 客户的账户列表
	private void customerAccountList(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		response.setContentType("text/html");
	...
	// 客户充值
	private void consumpMoney(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		response.setContentType("text/html");
