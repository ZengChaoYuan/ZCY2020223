...
<body>
	<div class="wrapper">
		<div class="content-side">
			<h1>欢迎登录心理咨询与诊断平台管理端</h1>
				  <table cellpadding="10">
   <tr>
    <td>用户名:</td>
    <td><input type="text" class="input" placeholder="请输入用户名" name="userName"
						id="userName"></td>
  </tr>
  <tr>
    <td>密码:</td>
  ...
  <tr>
  <td colspan="2" style="text-align: center;"><input type="button" id="loginBtn" value="登录"></td>
  </tr>
</table>
